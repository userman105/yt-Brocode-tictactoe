...
public class TicTacToe implements ActionListener{
   ...
   TicTacToe(){
       ...
       text_field.setBackground(new Color(56, 43, 43));
       ...
       new_game.setBounds(100,160,150,150);
       new_game.setFocusable(false);
       new_game.addActionListener(this);
       newGame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
       newGame.setSize(520,520);
       ...
       for(int i = 0;i<9;i++){
           ...
           buttons[i].setFont(new Font("MV Bold",Font.BOLD,120));
